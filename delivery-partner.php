...
<head>
  <meta charset="utf-8">
  <title>Delivery Partner | LoadRunnr</title>
...
<meta name="theme-color" content="#ffffff">
  ...
  .card-with-icon__icon img{height:130px; width:auto}
  .category-item p{color:#000}
...
$sql3 = $conn->prepare("SELECT * FROM driver_section1 ");
$sql3->execute();
$result3 = $sql3->fetch(PDO::FETCH_OBJ);

$sql4= $conn->prepare("SELECT * FROM driver_section2 ");
$sql4->execute();
$result4 = $sql4->fetch(PDO::FETCH_OBJ);

$sql5= $conn->prepare("SELECT * FROM driver_section3 ");
$sql5->execute();
$result5 = $sql5->fetch(PDO::FETCH_OBJ);

$sql6= $conn->prepare("SELECT * FROM driver_section4 ");
$sql6->execute();
        ...
        <div class="section-banner__bg" >
          <div class="uk-container uk-text-center">
            <div class="section-banner__content">
              <div class="section-banner__title">Delivery Partner</div>              
            </div>
          </div>
        </div>
      </div>
 ...
 <div class="section-steps">
        <div class=" uk-container">
          <div class="section-title uk-text-center">
            <h3 class="uk-h3"><?= $result3->title1; ?></h3>
            <p></p>
          </div>
                  ...
                  <li>
                    <div class="card-with-icon">
                      <div class="card-with-icon__box">
                        <div class="card-with-icon__icon"><img src="images/<?= $result3->image1; ?>"  alt="icon"></div>
                        <div class="card-with-icon__title"><?= $result3->point1; ?></div>
                        <div class="card-with-icon__text"><?= $result3->description1; ?></div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="card-with-icon">
                      <div class="card-with-icon__box">
                        <div class="card-with-icon__icon"><img src="images/<?= $result3->image2; ?>"  alt="icon"></div>
                        <div class="card-with-icon__title"><?= $result3->point2; ?></div>
                        <div class="card-with-icon__text"><?= $result3->description2; ?></div>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="card-with-icon">
                      <div class="card-with-icon__box">
                        <div class="card-with-icon__icon"><img src="images/<?= $result3->image3; ?>" alt="icon"></div>
                        <div class="card-with-icon__title"><?= $result3->point3; ?></div>
                        <div class="card-with-icon__text"><?= $result3->description3; ?></div>
                      </div>
                    </div>
                  </li>
                </ul>
                ...
                <ul class="uk-slider-items uk-grid uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-2@m uk-child-width-1-4@l uk-child-width-1-6@xl">
                  <li>
                    <div class="category-item"><a class="category-item__box" href="javascript:void(0);">
                        <div class="category-item__icon"><img src="images/<?= $result4->image1; ?>" width="120" alt="ico-category"></div>
                        <div class="category-item__title"><?= $result4->point1; ?></div>
                       <p><?= $result4->description1; ?></p>
                      </a></div>
                  </li>
                  <li>
                    <div class="category-item"><a class="category-item__box" href="javascript:void(0);">
                        <div class="category-item__icon"><img src="images/<?= $result4->image2; ?>" width="120" alt="ico-category"></div>
                        <div class="category-item__title"><?= $result4->point2; ?></div>
                        <p><?= $result4->description2; ?></p>
                      </a></div>
                  </li>
                  <li>
                    <div class="category-item"><a class="category-item__box" href="javascript:void(0);">
                        <div class="category-item__icon"><img src="images/<?= $result4->image3; ?>" width="120" alt="ico-category"></div>
                        <div class="category-item__title"><?= $result4->point3; ?></div>
                        <p><?= $result4->description3; ?></p>
                      </a></div>
                  </li>
 ...
 <div class="section-info">
        <div class="uk-section-large uk-container uk-container-large">
          <div class="uk-grid uk-child-width-1-2@m uk-flex-middle" data-uk-grid>
            <div class="uk-flex-last@m uk-text-center"><img src="images/<?= $result5->image; ?>" alt="img-info"></div>
            <div>
              <div class="section-content">
                <h3 class="uk-h3">  <?= $result5->title1; ?></h3>
                <ul class="info-list">
                  <li>
                    <div class="info-list-item">
                      <div class="info-list-item__icon"><img src="images/one.png" alt="ico-info"></div>
                      <div class="info-list-item__desc">
                        <div class="info-list-item__title"> <?= $result5->title2; ?></div>
                  ...
                  <li>
                    <div class="info-list-item">
                      <div class="info-list-item__icon"><img src="images/two.png" alt="ico-info"></div>
                      <div class="info-list-item__desc">
                        <div class="info-list-item__title"> <?= $result5->title3; ?></div>
                  ...
                  <li>
                    <div class="info-list-item">
                      <div class="info-list-item__icon"><img src="images/three.png" alt="ico-info"></div>
                      <div class="info-list-item__desc">
                        <div class="info-list-item__title"> <?= $result5->title4; ?></div>
