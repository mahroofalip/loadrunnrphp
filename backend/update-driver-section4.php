...
$sql3 = $conn->prepare("SELECT * FROM driver_section4 WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE driver_section4 SET description =?,image1=?,image2=?,url=?,image3 =?,urllink=? WHERE id = '".$_GET['id']."'");

if($sql->execute([$description,$image1,$image2,$url,$image3,$url1]))
{
 header("location:manage-driver-section4.php?msg=1");
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Driver Section(4) </li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Driver Section(4)</div>
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from driver_section4 where id='".$_GET['id']."' ");
                          $sqls->execute();
