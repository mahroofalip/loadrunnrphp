...
$sql = $conn->prepare("UPDATE `aboutus_section4` SET `title1`='".$title1."',`description1`='".$description1."',`title2`='".$title2."',`description2`='".$description2."',`title3`='".$title3."',`description3`='".$description3."' WHERE id='".$_GET['id']."' ");

if($sql->execute())
{
 header("location:manage-aboutus-section4.php?msg=1");
$_SESSION['msg']="<h4><strong>Success!</strong>Update Section4 Successfully.</h4>";
}
}
?>
<!DOCTYPE html>
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Section 4</li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Section 4</div>
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from aboutus_section4 where id='".$_GET['id']."' ");
                          $sqls->execute();
                        ...
                        ?>
                              ...
                              <div  class="form-body">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="title1" name="title1" required=""><?php echo $row->title1;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="description1" name="description1" required=""><?php echo $row->description1;?></textarea>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="title2" name="title2" required=""><?php echo $row->title2;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="description2" name="description2" required=""><?php echo $row->description2;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="title3" name="title3" required=""><?php echo $row->title3;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="description3" name="description3" required=""><?php echo $row->description3;?></textarea>
                                    </div>
                                  </div>
