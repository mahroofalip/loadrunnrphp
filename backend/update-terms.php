...
$sql = $conn->prepare("UPDATE terms_conditions SET description =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$description]))
{
header("location:manage-terms.php?msg=1");
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Terms & Conditions </div>
                            <div class="panel-body pan">
                              ...
                              <?php
                                 $sqls=$conn->prepare("SELECT * FROM terms_conditions WHERE id='".$_GET['id']."' ");
                                 $sqls->execute();
