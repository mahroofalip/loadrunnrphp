...
$sql3 = $conn->prepare("SELECT * FROM driver_section3 WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE driver_section3 SET image=?,title1=?,title2=?,title3=?,title4 =? WHERE id = '".$_GET['id']."'");

if($sql->execute([$image,$title1,$title2,$title3,$title4]))
{
 header("location:manage-driver-section3.php?msg=1");
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Driver Section(3) </li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Driver Section(3)</div>
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from driver_section3 where id='".$_GET['id']."' ");
                          $sqls->execute();
                                 ...
                                 <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      ...
                                      <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label"> Title4<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="title4" name="title4"><?php echo $row->title4;?></textarea>
                                    </div>
                                  </div>
