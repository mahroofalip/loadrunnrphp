...
$sql3 = $conn->prepare("SELECT * FROM home_section2 WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$path5 = "../images/";
$image5 = uniqid().$img_name5;
move_uploaded_file($tmp_name5,$path5.$image5);
unlink("../images/".$oldImg5);
}
else{
$image5 = $oldImg5;
}  
...
$sql = $conn->prepare("UPDATE home_section2 SET title1 =?,title2=?,title3 =?,image1=?,point1=?,image2=?,point2=?,image3 =?,point3=?,image4 =?,point4=?,image5 =?,point5=? WHERE id = '".$_GET['id']."'");

if($sql->execute([$title1,$title2,$title3,$image1,$point1,$image2,$point2,$image3,$point3,$image4,$point4,$image5,$point5]))
{
 header("location:manage-home-section2.php?msg=1");
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Home Section(2) </li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Home Section(2)</div>
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from home_section2 where id='".$_GET['id']."' ");
                          $sqls->execute();
                        ...
                        ?>
                              ...
                              <div  class="form-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="title3" name="title3"><?php echo $row->title3;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <span style="color: red;">Image Size Should Be 150x150 PX</span>
                                ...
                                <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Image5<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <input type="file" class="form-control" name="image5" placeholder="Enter Image" >
                                    <img width="50" src="../images/<?php echo $row->image5;?>">
                                   <span style="color: red;">Image Size Should Be 150x150 PX</span>
                                     ...
                                     <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Point5<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="point5" name="point5"><?php echo $row->point5;?></textarea>
                                    </div>
                                  </div>
