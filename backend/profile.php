...
<style>
 .manage{ padding:0 10px;}
 .welcome{ color:#0A819C;}
 .shadow-box{ box-shadow:10px 10px 10px #eee ;  border:1px solid #0A819C}
        @media print
{
.noprint {display:none;}
#print{display:inline-table!important; display:block!important;}
.edit-txt{ color:#47A447;}
...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
    ...
    <ol class="breadcrumb page-breadcrumb pull-left">
       <li><i class="fa fa-home"></i>&nbsp;<a href="profile.php">Dashboard</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
