        ...
        <div id="page-wrapper">
          ...
          <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
            ...
            <ol class="breadcrumb page-breadcrumb pull-left">
              ...
              <li class="active">Manage Contact Us Content</li>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Contact Us Content</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                      ...
                      $sql = $conn->prepare("SELECT * FROM contact_content ");
                      $sql->execute();
                      ...
                      ?>
                       ...
                       <tr>
                            <th>Address</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->address; ?></textarea></td>
                       </tr>

                        <tr>
                            <th>Email</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->email; ?></textarea></td>
                       </tr>

                         <tr>
                            <th>Phone</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->phone; ?></textarea></td>
                         ...
                         <tr>
                        <td>
                          <a href="update-contactuscon.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                        </td>
