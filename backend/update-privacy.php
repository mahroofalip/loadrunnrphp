...
$sql = $conn->prepare("UPDATE privacy SET description =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$description]))
{
header("location:manage-privacy.php?msg=1");
$_SESSION['msg']="<h4><strong>Success!</strong>Update Privacy Policy Successfully.</h4>";
}
}
?>
<!DOCTYPE html>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            ...
                            <div class="panel-body pan">
                              ...
                              <?php
                                 $sqls=$conn->prepare("SELECT * FROM privacy WHERE id='".$_GET['id']."' ");
                                 $sqls->execute();
