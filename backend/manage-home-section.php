        ...
        <div id="page-wrapper">
          ...
          <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
            ...
            <ol class="breadcrumb page-breadcrumb pull-left">
              ...
              <li class="active">Manage Home Section(2)</li>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Home Section(2)</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                      ...
                      $sql = $conn->prepare("SELECT * FROM home_section");
                      $sql->execute();
                      ...
                      ?>
                       ...
                       <tr>
                            <th>Description</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->description; ?></textarea></td>
                       </tr>

                        <tr>
                            <th>Point1</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->point1; ?></textarea></td>

                       </tr>

                        <tr>
                            <th>Point2</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->point2; ?></textarea></td>

                       </tr>

                       <tr>
                            <th>Point3</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->point3; ?></textarea></td>
                       </tr>
                       ...
                       <tr>
                            <th>Video Link</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->video; ?></textarea></td>
                       </tr>


                         <tr>
                        <td>
                          <a href="update-home-section.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                        </td>
