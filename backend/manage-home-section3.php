        ...
        <div id="page-wrapper">
          ...
          <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
            ...
            <ol class="breadcrumb page-breadcrumb pull-left">
              ...
              <li class="active">Manage Home Section(3)</li>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Home Section(3)</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                     ...
                     $sql = $conn->prepare("SELECT * FROM home_section3");
                     $sql->execute();
                     ...
                     <tr>
                      <th>Title1</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->title1; ?></textarea></td>

                    </tr>

                    <tr>
                      <th>Title2</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->title2; ?></textarea></td>

                    </tr>

                    <tr>
                      <th>Title3</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->title3; ?></textarea></td>
                    ...
                    <tr>
                      <th>Image1</th>
                      <td><img width="75" src="../images/<?=$result->image1;?>"></td>
                    </tr>

                    <tr>
                      <th>Point1</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->point1; ?></textarea>
                     ...
                     <tr>
                      <th>Description1</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->desc1; ?></textarea>
                    ...
                    <tr>
                      <th>Image2</th>
                      <td><img width="75" src="../images/<?=$result->image2;?>"></td>
                    </tr>

                    <tr>
                      <th>Point2</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->point2; ?></textarea>
                      ...
                      <tr>
                      <th>Description2</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->desc2; ?></textarea>
                    ...
                    <tr>
                      <th>Image3</th>
                      <td><img width="75" src="../images/<?=$result->image3;?>"></td>
                    </tr>

                    <tr>
                      <th>Point3</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->point3; ?></textarea>
                      ...
                      <tr>
                      <th>Description3</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->desc3; ?></textarea>
                    ...
                    <tr>
                      <td>
                        <a href="update-home-section3.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                      </td>
