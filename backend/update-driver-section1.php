...
$sql3 = $conn->prepare("SELECT * FROM driver_section1 WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE driver_section1 SET title1 =?,image1=?,point1=?,desc1=?,image2=?,point2=?,desc2=?,image3 =?,point3=?,desc3=? WHERE id = '".$_GET['id']."'");

if($sql->execute([$title1,$image1,$point1,$desc1,$image2,$point2,$desc2,$image3,$point3,$desc3]))
{
 header("location:manage-driver-section1.php?msg=1");
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Driver Section(1) </li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Driver Section(1)</div>
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from driver_section1 where id='".$_GET['id']."' ");
                          $sqls->execute();
