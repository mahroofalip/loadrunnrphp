...
$sql3 = $conn->prepare("SELECT * FROM aboutus_section2 WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE `aboutus_section2` SET `description`='".$description."',`image`='".$image."',`link`='".$link."' WHERE id='".$_GET['id']."' ");

if($sql->execute())
{
 header("location:manage-aboutus-section2.php?msg=1");
$_SESSION['msg']="<h4><strong>Success!</strong>Update Section2 Successfully.</h4>";
}
}
?>
<!DOCTYPE html>
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Section 2</li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Section 2</div>
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from aboutus_section2 where id='".$_GET['id']."' ");
                          $sqls->execute();
                        ...
                        ?>
                              ...
                              <div  class="form-body">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="description" name="description" required=""><?php echo $row->description;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Link <span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="link" name="link" required=""><?php echo $row->link;?></textarea>
                                    </div>
                                  </div>
