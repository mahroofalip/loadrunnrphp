              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Links</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                      ...
                      $sql = $conn->prepare("SELECT * FROM social_media ");
                      $sql->execute();
                      ...
                      ?>
                        <tr>
                            <th>Twitter Link</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->twitter; ?></textarea></td>

                       </tr>

                       <tr>
                            <th>Facebook Link</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->fb; ?></textarea></td>
                       </tr>

                        <tr>
                            <th>Instagram Link</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->insta; ?></textarea></td>
                       </tr>

                         <tr>
                            <th>Linkedin Link</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->linkedin; ?></textarea></td>

                       </tr>

                         <tr>
                            <th>Youtube Link</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->youtube; ?></textarea></td>
                         ...
                         <tr>
                        <td>
                          <a href="update-links.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                        </td>
