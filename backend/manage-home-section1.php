        ...
        <div id="page-wrapper">
          ...
          <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
            ...
            <ol class="breadcrumb page-breadcrumb pull-left">
              ...
              <li class="active">Manage Home Section(1)</li>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Home Section(1)</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                      ...
                      $sql = $conn->prepare("SELECT * FROM home_section1");
                      $sql->execute();
                      ...
                      ?>
                        <tr>
                            <th>Title</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->title; ?></textarea></td>

                       </tr>

                       <tr>
                            <th>Image</th>
                            <td><img width="75" src="../images/<?=$result->image;?>"></td>
                             </tr>
                        ...
                        <tr>
                            <th>Title1</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->logo_title1; ?></textarea></td>

                       </tr>
                         
                          <tr>
                            <th>Image1</th>
                            <td><img width="75" src="../images/<?=$result->logo1;?>"></td>
                             </tr>


                       <tr>
                            <th>Description1</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->logo_description1; ?></textarea></td>
                       </tr>

                       
                      <tr>
                            <th>Title2</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->logo_title2; ?></textarea></td>

                       </tr>
                        
                        <tr>
                            <th>Image2</th>
                            <td><img width="75" src="../images/<?=$result->logo2;?>"></td>
                        </tr>

                       <tr>
                            <th>Description2</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->logo_description2; ?></textarea></td>
                       </tr>


                           <tr>
                            <th>Title3</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->logo_title3; ?></textarea></td>

                       </tr>

                          <tr>
                            <th>Image3</th>
                            <td><img width="75" src="../images/<?=$result->logo3;?>"></td>
                             </tr>


                       <tr>
                            <th>Description3</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->logo_description3; ?></textarea></td>
                       </tr>

                         <tr>
                        <td>
                          <a href="update-home-section1.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                        </td>
