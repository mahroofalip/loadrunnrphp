...
$sql = $conn->prepare("UPDATE contact_con SET description1 =?,description2 =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$description1,$description2]))
{
header("location:manage-contactcon.php?msg=1");
$_SESSION['msg']="
                          ...
                          <div class="panel panel-blue">
                            ...
                            <div class="panel-body pan">
                              ...
                              <div class="panel-heading">
                               ...
                               <?php
                          $sqls=$conn->prepare("SELECT * FROM contact_con WHERE id='".$_GET['id']."' ");
                          $sqls->execute();
                          ...
                          ?>
                              ...
                              <div  class="form-body">
                                  ...
                                  <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Contact Us Description<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="90" id="description1" name="description1"><?php echo $row->description1;?></textarea>
                                    </div>
                                  </div>
                               <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Banner Top Description<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="90" id="description2" name="description2"><?php echo $row->description2;?></textarea>
                                    </div>
                                  </div>
