...
$sql3 = $conn->prepare("SELECT * FROM home_section3 WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE home_section3 SET title1 =?,title2=?,title3 =?,image1=?,point1=?,desc1=?,image2=?,point2=?,desc2=?,image3 =?,point3=?,desc3=? WHERE id = '".$_GET['id']."'");

if($sql->execute([$title1,$title2,$title3,$image1,$point1,$desc1,$image2,$point2,$desc2,$image3,$point3,$desc3]))
{
 header("location:manage-home-section3.php?msg=1");
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Home Section(3) </li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Home Section(3)</div>
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from home_section3 where id='".$_GET['id']."' ");
                          $sqls->execute();
                        ...
                        ?>
                              ...
                              <div  class="form-body">
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Desc1<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="desc1" name="desc1"><?php echo $row->desc1;?></textarea>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Desc2<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="desc2" name="desc2"><?php echo $row->desc2;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Desc3<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="desc3" name="desc3"><?php echo $row->desc3;?></textarea>
                                    </div>
                                  </div>
