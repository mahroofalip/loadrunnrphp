              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Logo</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    ...
                    <tbody>
                      <?php
                      $i = 1;
                      $sql = $conn->prepare("SELECT * FROM logo ORDER BY id DESC");
                      $sql->execute();
                      ...
                      <tr>
                       <td><?php echo $data->title;?></td>
                        <td><img width="80" src="../images/<?=$data->image;?>"></td>
                        <td>
                          <a href="update-logo.php?id=<?php echo $data->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                        </td>
