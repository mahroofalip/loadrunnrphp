        ...
        <div id="page-wrapper">
          ...
          <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
            ...
            <ol class="breadcrumb page-breadcrumb pull-left">
              ...
              <li class="active">Manage Driver Section(4)</li>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Driver Section(4)</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                     ...
                     $sql = $conn->prepare("SELECT * FROM driver_section4");
                     $sql->execute();
                    ...
                    <tr>
                      <td>
                        <a href="update-driver-section4.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                      </td>
