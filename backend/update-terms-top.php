...
$sql = $conn->prepare("UPDATE terms_conditions_content SET title =?, description =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$title,$description]))
{
header("location:manage-terms-top.php?msg=1");
$_SESSION['msg']="<h4><strong>Success!</strong>Update Terms & Conditions Successfully.</h4>";
}
}
?>
<!DOCTYPE html>
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Terms & Conditions Top Content</li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Terms & Conditions Top Content</div>
                            <div class="panel-body pan">
                              ...
                              <?php
                                 $sqls=$conn->prepare("SELECT * FROM terms_conditions_content WHERE id='".$_GET['id']."' ");
                                 $sqls->execute();
                              ...
                              <div  class="form-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="10" cols="100" id="description" name="description"><?php echo $row->description;?></textarea>
                                    </div>
                                  </div>
