...
$sql = $conn->prepare("UPDATE social_media SET twitter=?,fb=?,insta =?,linkedin =?,youtube =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$twitter,$fb,$insta,$linkedin,$youtube]))
{
header("location:manage-links.php?msg=1");
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Links</li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Links </div>
                            <div class="panel-body pan">
                              ...
                              <?php
                                $i = 1;
                                $id=$_GET['id'];
                                $sql = $conn->prepare("SELECT * FROM social_media where id='".$id."' ");
                                $sql->execute();
                            ...
                            <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="title" name="twitter"><?php echo $result->twitter;?></textarea>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="" name="fb"><?php echo $result->fb;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="" name="insta"><?php echo $result->insta;?></textarea>
                                    </div>
                                  </div>

                                  <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Linkedin Link<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="" name="linkedin"><?php echo $result->linkedin;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="" name="youtube"><?php echo $result->youtube;?></textarea>
                                    </div>
                                  </div>
