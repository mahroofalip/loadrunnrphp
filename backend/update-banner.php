...
$sql3 = $conn->prepare("SELECT * FROM banner WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE banner SET title1 =?,title2 =?,image =? WHERE id = '".$_GET['id']."'");

if($sql->execute([$title1,$title2,$image]))
{
 header("location:manage-banner.php?msg=1");
 $_SESSION['msg']="<h4><strong>Success!</strong>Update Banner Successfully.</h4>";
}
}
?>
<!DOCTYPE html>
  <html lang="en">
    ...
    <body class="">
      <div>
                  ...
                  <div id="tableactionTabContent" class="tab-content">
                    ...
                    <div id="pp" class="tab-pane fade in active">
                      <div class="row">
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from banner where id='".$_GET['id']."' ");
                          $sqls->execute();
                        ...
                        ?>
                              ...
                              <div  class="form-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <input type="text" class="form-control" name="title1" placeholder="Title1 Name" value="<?php echo $row->title1;?>" required ="">
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <input type="text" class="form-control" name="title2" placeholder="Title2 Name" value="<?php echo $row->title2;?>" required ="">
                                    </div>
                                  </div>
                                   ...
                                   <span style="color: red;">Image Size Should Be 1900x830 PX</span>
        ...
        // CKEDITOR.replace( 'industry_desc');
        </script>
