        ...
        <div id="page-wrapper">
          ...
          <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
            ...
            <ol class="breadcrumb page-breadcrumb pull-left">
              ...
              <li class="active">Manage Terms & Conditions
</li>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Terms & Conditions</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    ...
                    <tbody>
                      <?php
                      $i = 1;
                      $sql = $conn->prepare("SELECT * FROM terms_conditions ORDER BY id ASC");
                      $sql->execute();
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="update-terms.php?id=<?php echo $data->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                        </td>
                      </tr>
                      <?php $i++; } ?>
