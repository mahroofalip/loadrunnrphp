                ...
                <div class="table-responsive">
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                     ...
                     $sql = $conn->prepare("SELECT * FROM home_section2");
                     $sql->execute();
                    ...
                    <tr>
                      ...
                      <tr>
                      <th>Image5</th>
                      <td><img width="75" src="../images/<?=$result->image5;?>"></td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        <a href="update-home-section2.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                      </td>
