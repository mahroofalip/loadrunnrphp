...
$sql3 = $conn->prepare("SELECT * FROM home_section WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE home_section SET title1 =?,title2 =?,description =?,image=?,point1=?,point2=?,point3 =?,video=? WHERE id = '".$_GET['id']."'");

if($sql->execute([$title1,$title2,$description,$image,$point1,$point2,$point3,$video]))
{
 header("location:manage-home-section.php?msg=1");
                  ...
                  <div id="tableactionTabContent" class="tab-content">
                    ...
                    <div id="pp" class="tab-pane fade in active">
                      <div class="row">
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from home_section where id='".$_GET['id']."' ");
                          $sqls->execute();
                        ...
                        ?>
                              ...
                              <div  class="form-body">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="title" name="title1"><?php echo $row->title1;?></textarea>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="title" name="title2"><?php echo $row->title2;?></textarea>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Video Link<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="video" name="video"><?php echo $row->video;?></textarea>
                                    </div>
                                  </div>
