...
$sql = $conn->prepare("UPDATE about_section1 SET title=?,description =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$title,$description]))
{
header("location:manage-about-section1.php?msg=1");
$_SESSION['msg']="<h4><strong>Success!</strong>Update About Section Successfully.</h4>";
}
}
?>
<!DOCTYPE html>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            ...
                            <div class="panel-body pan">
                              ...
                              <?php
                                 $sqls=$conn->prepare("SELECT * FROM about_section1 WHERE id='".$_GET['id']."' ");
                                 $sqls->execute();
                              ...
                              <div  class="form-body">
                                  <div  class="form-body">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="10" cols="100" id="title" name="title"><?php echo $row->title;?></textarea>
                                    </div>
                                  </div>
