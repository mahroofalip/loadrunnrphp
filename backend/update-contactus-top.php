...
$sql = $conn->prepare("UPDATE contactus_top_content SET title =?, description =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$title,$description]))
{
header("location:manage-contactus-top-section.php?msg=1");
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Contact Us Top Content</li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Contact Us Top Content</div>
                            <div class="panel-body pan">
                              ...
                              <?php
                                 $sqls=$conn->prepare("SELECT * FROM contactus_top_content WHERE id='".$_GET['id']."' ");
                                 $sqls->execute();
