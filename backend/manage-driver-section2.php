        ...
        <div id="page-wrapper">
          ...
          <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
            ...
            <ol class="breadcrumb page-breadcrumb pull-left">
              ...
              <li class="active">Manage Driver Section(2)</li>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Driver Section(2)</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                     ...
                     $sql = $conn->prepare("SELECT * FROM driver_section2");
                     $sql->execute();
                    ...
                    <tr>
                     ...
                     <tr>
                      <th>Description1</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->description1; ?></textarea>
                    ...
                    <tr>
                      ...
                      <tr>
                      <th>Description2</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->description2; ?></textarea>
                    ...
                    <tr>
                      ...
                      <tr>
                      <th>Description3</th>
                      <td><textarea readonly="" cols="30" rows="5"><?= $result->description3; ?></textarea>
                    ...
                    <tr>
                      <td>
                        <a href="update-driver-section2.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                      </td>
