...
$sql = $conn->prepare("UPDATE contact_header_con SET hr =?,sales1 =?,sales2 =?,email =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$hr,$sales1,$sales2,$email]))
{
header("location:manage-header-contactus.php?msg=1");
$_SESSION['msg']="
    <h4><strong>Success!</strong>Update Contact Us Content Successfully.</h4>
";
}
}
?>
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Header Contact Us Content</li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Header Contact Us Content</div>
                            <div class="panel-body pan">
                              ...
                              <div class="panel-heading">
                               ...
                               <?php
                          $sqls=$conn->prepare("SELECT * FROM contact_header_con WHERE id='".$_GET['id']."' ");
                          $sqls->execute();
                          ...
                          ?>
                              ...
                              <div  class="form-body">
                                  ...
                                  <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">HR Dept No.<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="90" id="hr" name="hr"><?php echo $row->hr;?></textarea>
                                    </div>
                                  </div>
                               <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Sales Dept No.1<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="90" id="sales1" name="sales1"><?php echo $row->sales1;?></textarea>
                                    </div>
                                  </div>

                                   <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Sales Dept No.2<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="90" id="sales2" name="sales2"><?php echo $row->sales2;?></textarea>
                                    </div>
                                  </div>

                                  <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Email<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="90" id="email" name="email"><?php echo $row->email;?></textarea>
                                    </div>
                                  </div>
