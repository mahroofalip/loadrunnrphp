...
$sql = $conn->prepare("UPDATE contact_content SET title=?,address=?,email =?,phone =? WHERE id = '".$_GET['id']."'");
if($sql->execute([$title,$address,$email,$phone]))
{
header("location:manage-contactuscon.php?msg=1");
$_SESSION['msg']="<h4><strong>Success!</strong>Update Contact Us Content Successfully.</h4>";
}
}
?>
<!DOCTYPE html>
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Contact Us Content</li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Contact Us Content</div>
                            <div class="panel-body pan">
                              ...
                              <?php
                                $i = 1;
                                $id=$_GET['id'];
                                $sql = $conn->prepare("SELECT * FROM contact_content where id='".$id."' ");
                                $sql->execute();
                            ...
                            <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="title" name="title"><?php echo $result->title;?></textarea>
                                    </div>
                                  </div>
                                 

                                  <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Address<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="" name="address"><?php echo $result->address;?></textarea>
                                    </div>
                                  </div>

                                   <div class="form-group">
                                    <label for="inputFirstName" class="col-md-2 control-label">Phone<span style="color:#FF0000"></span></label>
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="" name="phone"><?php echo $result->phone;?></textarea>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="100" id="" name="email"><?php echo $result->email;?></textarea>
                                    </div>
                                  </div>
