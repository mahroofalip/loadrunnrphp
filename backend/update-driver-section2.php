...
$sql3 = $conn->prepare("SELECT * FROM driver_section2 WHERE id = '".$_GET['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE driver_section2 SET title1 =?,title2=?,image1=?,point1=?,description1 =?,image2=?,point2=?,description2 =?,image3 =?,point3=?,description3 =? WHERE id = '".$_GET['id']."'");

if($sql->execute([$title1,$title2,$image1,$point1,$description1,$image2,$point2,$description2,$image3,$point3,$description3]))
{
 header("location:manage-driver-section2.php?msg=1");
          ...
          <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
              ...
              <ol class="breadcrumb page-breadcrumb pull-left">
                ...
                <li class="active">Update Driver Section(2) </li>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="panel panel-blue">
                            <div class="panel-heading">Update Driver Section(2)</div>
                        ...
                        <?php
                          $sqls=$conn->prepare("select * from driver_section2 where id='".$_GET['id']."' ");
                          $sqls->execute();
                              ...
                              <div  class="form-body">
                                  ...
                                  <div class="form-group">
                                   ...
                                   <span style="color: red;">Image Size Should Be 1900x600 PX</span>
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="description1" name="description1"><?php echo $row->description1;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <span style="color: red;">Image Size Should Be 1900x600 PX</span>
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="description2" name="description2"><?php echo $row->description2;?></textarea>
                                    </div>
                                  </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                      <textarea rows="8" cols="75" id="description3" name="description3"><?php echo $row->description3;?></textarea>
                                    </div>
                                  </div>
