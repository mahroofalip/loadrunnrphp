        ...
        <div id="page-wrapper">
          ...
          <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb noprint">
            ...
            <ol class="breadcrumb page-breadcrumb pull-left">
              ...
              <li class="active">Manage Driver Section(3)</li>
              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <div class="panel-heading">
                    <h4 align="center" class="panel-title" style="color:#FF0000;"><strong>Manage Driver Section(3)</strong></h4>
                  ...
                  <table id="table_id" class="table table-hover table-6striped table-bordered table-advanced tablesorter display">
                    <thead>
                      ...
                      $sql = $conn->prepare("SELECT * FROM driver_section3");
                      $sql->execute();
                      ...
                      <tr>
                        ...
                        <tr>
                            <th>Title4</th>
                           <td><textarea readonly="" cols="30" rows="5"><?= $result->title4; ?></textarea></td>
                         ...
                         <tr>
                        <td>
                          <a href="update-driver-section3.php?id=<?php echo $result->id;?>" class="btn btn-warning btn-xs" title="Update">Update</a>
                        </td>
